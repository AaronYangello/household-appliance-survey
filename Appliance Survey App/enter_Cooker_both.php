	...
	<div class="container">
		...
		<div class="card justify-content-center mx-auto" style="width: 75%">
			<div class="card-header">
				<h1>Add Cooker with both Oven and Cooktop:</h1>
			</div>
			<div class="card-body mx-5">
				<div class="w-50">


					<div class="subtitle">Please provide the details regarding the Cooker with Cooktop and Oven.</div>
					...
					<form name="applianceinfo" action="enter_Cooker_both.php" method="post">
						<table>
							...
							<tr>
								...
								<td>
									...
									<input type="radio" name="options" value="Both" autocomplete="off" <?php if
							...
							<tr>
								<td class="Heat_Source">Oven Heat Source:</td>
								<td>


									<input type="radio" name="Oven_Heat_Source" value="Gas" autocomplete="off" checked>
									Gas
									<input type="radio" name="Oven_Heat_Source" value="Electric" autocomplete="off"
										checked> Electric
									<input type="radio" name="Oven_Heat_Source" value="Microwave" autocomplete="off"
										checked> Microwave
							...
							<td class="item_label">Oven Type:</td>
							<td>
								<select name="OvenType">
							...
							<tr>
								<td class="Heat_Source">Cooktop Heat Source:</td>
								<td>
