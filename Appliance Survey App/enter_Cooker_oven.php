		...
		<div class="card justify-content-center mx-auto" style="width: 75%">
			...
			<div class="card-body mx-5">
				<div class="w-50">
					...
					<div class="subtitle">Please provide the details regarding the Cooker Oven.</div>
					...
					<form name="applianceinfo" action="enter_Cooker_oven.php" method="post">
						<table>
							...
							<tr>
								...
								<td>
									...
									<input type="radio" name="options" value="Oven" autocomplete="off" <?php if
